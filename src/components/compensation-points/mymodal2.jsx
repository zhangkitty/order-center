...
const Mymodal2 = (props) => {
  ...
  const { dispatch, all_pointType, selectedRows2, all_siteFrom, all_country, all_COD_status, modalShow2, all_order_status, siteFrom2, country2, COD_status2, order_status2 } = props;
  return (
    <Modal
      visible={modalShow2}
