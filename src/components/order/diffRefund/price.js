                ...
                v.isShow ?
                  ...
                  >
                    ...
                    >
                      ...
                      {
                        v.refund_account_type_list.length > 0 ?
                          <div style={{ display: 'flex' }}>
                            <Select defaultValue={lan.please_select_a_refund_account} style={{ width: '150px' }}>
                              {
                                v.refund_account_type_list.map((v, k) => <Option key={v.id} value={v.name}>{v.name}</Option>)
                              }
                            </Select>
                            <Input
                              // disabled={active}
                              type="text"
                              style={v.refundTypeId == 4 || 3 ? { display: '', width: '150px', marginLeft: '20px' } : { display: 'none' }}
