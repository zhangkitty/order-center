...
export const addOrEditSerSuccess = makeActionCreator(types.addOrEditSerSuccess, 'val');
...
export const getTroubleInfoConfig = makeActionCreator(types.getTroubleInfoConfig);
export const getDatabase = makeActionCreator(types.getDatabase);
export const addOrEditVisible = makeActionCreator(types.addOrEditVisible, 'data');
