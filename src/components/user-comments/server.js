...
export const tagSer=action =>{
  const table  = {
    1:{is_trouble:action.props.troubleTag,order_id:action.props.order_id,type:action.key,remark:action.props.markTag,trouble_reason:action.props.trouble_reason},
